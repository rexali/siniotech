...
export default function RecruiterPage() {
    ...
    return (
        <main>
            ...
            <div>
                <iframe className="d-block mx-auto" src="https://docs.google.com/forms/d/e/1FAIpQLScyKvPLMuHLp6kpp5oOzOPcGIs9YDNgpcrEPhyneJipvTKigg/viewform?embedded=true" width="700" height="520">Loading…</iframe>
            </div>
        </main>
    )
