...
export default function Page() {
    ...
    return (
        <main>
            ...
            <div>
                <iframe className="d-block mx-auto" src="https://docs.google.com/forms/d/e/1FAIpQLSesFTMvuNXVe2UP1JiD7i5ISSSmtrknBdAU7Pm_-5DN2aYM9Q/viewform?embedded=true" width="640" height="1967">Loading…</iframe>
            </div>
        </main>
    )
