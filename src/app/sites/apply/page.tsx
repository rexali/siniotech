...
export default function Page() {
    ...
    return (
        <main>
            ...
            <div>
                <iframe className="d-block mx-auto" src="https://docs.google.com/forms/d/e/1FAIpQLScQWj1Tt63JmUZBrWDDMhV_OBcdqZWD9V3fZhHOI3Zs8EwdjQ/viewform?embedded=true" width="640" height="1936">Loading…</iframe>
            </div>
        </main>
    )
