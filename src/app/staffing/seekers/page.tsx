...
export default function RecruiterPage() {
    ...
    return (
        <main>
            ...
            <div>
                <iframe className="d-block mx-auto" width="640" height="1140" src="https://docs.google.com/forms/d/e/1FAIpQLSeKFnG38GnNPdAnys8R2tNNsqgOhHE8f8LovRHjA3l3j8UTrA/viewform?embedded=true" >Loading…</iframe>
            </div>
        </main>
    )
